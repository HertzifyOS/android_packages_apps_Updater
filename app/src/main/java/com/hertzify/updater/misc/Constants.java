...
public final class Constants {
    ...
    public static final String PROP_ALLOW_MAJOR_UPGRADES = "hertzify.updater.allow_major_upgrades";
    public static final String PROP_BUILD_DATE = "ro.build.date.utc";
    public static final String PROP_BUILD_VARIANT = "ro.hertzify.build.variant";
    public static final String PROP_BUILD_VERSION = "ro.hertzify.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.hertzify.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.hertzify.build.type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "hertzify.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "hertzify.updater.uri";
