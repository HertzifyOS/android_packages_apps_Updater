...
resource (or the `hertzify.updater.uri` system property) and expects as response
...
The `romtype` attribute is the string to be compared with the `ro.hertzify.build.type` property.  
